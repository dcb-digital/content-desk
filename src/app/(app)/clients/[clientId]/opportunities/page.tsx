...
import { StatusButton, DeleteOpportunityButton } from "./opportunity-actions";
  ...
  return (
    <div className="space-y-6">
      ...
      {allOpps.length === 0 ? (
        ...
        <OppSection title="Open" opps={open} clientId={clientId} />
      )}

      {planned.length > 0 && <OppSection title="Planned" opps={planned} clientId={clientId} />}
      {dismissed.length > 0 && <OppSection title="Dismissed" opps={dismissed} clientId={clientId} dim />}
    </div>
  );
}
